...
import uk.ac.standrews.cs.digitising_scotland.linkage.distance_based.BirthOwnMarriageThresholdNN;
 ...
 */
public class BirthOwnMarriageThresholdNNTruthChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            BirthOwnMarriageThresholdNN matcher = new BirthOwnMarriageThresholdNN(store_path,repo_name);
