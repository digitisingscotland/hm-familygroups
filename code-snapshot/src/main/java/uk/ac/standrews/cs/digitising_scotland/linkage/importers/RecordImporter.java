...
public abstract class RecordImporter {
    ...
    public abstract HashMap<Integer, String> getRecordMap();

    public abstract int[] getUnavailableRecords();

    public static void addAvailableSingleFields(final DataSet data, final List<String> record, final LXP lxp_record, HashMap<Integer, String> label_map) {
