 ...
 */
public class GFNGLNBFNBMNPOMDOMDistanceOverBirthClean implements Distance<Birth> {
    ...
    private float FFNdistance(Birth b1, Birth m2) {
        return levenshtein.distance( b1.getFathersSurnameClean(), m2.getFathersSurnameClean() );
    }

    private float FLNdistance(Birth b1, Birth m2) {
        return levenshtein.distance( b1.getFathersForenameClean(), m2.getFathersForenameClean() );
    }

    private float MFNdistance(Birth b1, Birth m2) {
        return levenshtein.distance( b1.getMothersForenameClean(), m2.getMothersForenameClean() );
    }

    private float MMNdistance(Birth b1, Birth m2) {
        return levenshtein.distance( b1.getMothersSurnameClean(), m2.getMothersSurnameClean() );
    }
