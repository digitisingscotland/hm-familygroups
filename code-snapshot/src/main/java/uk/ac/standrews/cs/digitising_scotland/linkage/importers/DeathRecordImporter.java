...
public abstract class DeathRecordImporter extends RecordImporter {
     ...
     */
    public int importDeathRecords(IBucket<Death> deaths, String deaths_source_path ) throws RecordFormatException, IOException, BucketException, IllegalKeyException {
     ...
     * Fills in a record.
     */
    private Death importDeathRecord(DataSet data, List<String> record) throws IOException, RecordFormatException, IllegalKeyException {
