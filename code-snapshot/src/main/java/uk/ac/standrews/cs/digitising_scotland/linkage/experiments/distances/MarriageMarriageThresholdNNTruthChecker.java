...
import uk.ac.standrews.cs.digitising_scotland.linkage.distance_based.MarriageMarriageThresholdNN;
 ...
 */
public class MarriageMarriageThresholdNNTruthChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            MarriageMarriageThresholdNN matcher = new MarriageMarriageThresholdNN(store_path,repo_name);
