 ...
 */
public class FFNFLNMFNMMNOverMarriage extends AbstractBlocker<Marriage> {

    public FFNFLNMFNMMNOverMarriage(final IBucket<Marriage> birthsBucket, final IRepository output_repo, Class<Marriage> clazz) throws BucketException, RepositoryException, IOException {
    ...
    public String[] determineBlockedBucketNamesForRecord(final Marriage record) throws NoSuitableBucketException {
        ...
        try {
            ...
            String bucket_name = concatenate(normalised_groom_forename, normalised_groom_surname, normalised_bride_forename, normalised_bride_surname);
