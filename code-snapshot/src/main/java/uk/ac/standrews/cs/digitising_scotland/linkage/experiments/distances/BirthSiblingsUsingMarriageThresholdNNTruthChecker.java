...
import uk.ac.standrews.cs.digitising_scotland.linkage.distance_based.BirthSiblingsUsingMarriageThresholdNN;
 ...
 */
public class BirthSiblingsUsingMarriageThresholdNNTruthChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            BirthSiblingsUsingMarriageThresholdNN matcher = new BirthSiblingsUsingMarriageThresholdNN(store_path,repo_name);
