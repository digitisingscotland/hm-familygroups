...
import uk.ac.standrews.cs.digitising_scotland.linkage.distance_based.BirthParentsMarriageThresholdNN;
 ...
 */
public class BirthParentsMarriageThresholdNNTruthChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            BirthParentsMarriageThresholdNN matcher = new BirthParentsMarriageThresholdNN(store_path,repo_name);
