...
import uk.ac.standrews.cs.digitising_scotland.linkage.distance_based.BirthBirthWithinDistance;
 ...
 */
public class BirthBirthWithinDistanceGroundTruthChecker {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (args.length >= ARG_NAMES.length) {
            ...
            BirthBirthWithinDistance matcher = new BirthBirthWithinDistance(store_path,repo_name);
