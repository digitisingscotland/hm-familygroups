...
public class Birth extends StaticLXP {
    ...
    public ParentNames toParentNames() {
        return new ParentNames(this.getId(), this.getString(FAMILY),
                this.getFathersForename(), this.getFathersSurname(),
                this.getMothersForename(), this.getMothersMaidenSurname());
    }
    ...
    public String toString() { return "BrithGT"; }
}
