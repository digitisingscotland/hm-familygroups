...
public enum BirthMarriageDateDistance implements Distance<Birth> {
    ...
    private static float levenshteinDistance(Birth b1, Birth b2, int selector) {
    ...
    private static float levenshteinDistanceWithNullFiltering(Birth b1, Birth b2, int selector) {

        return levenshteinDistanceWithNullFiltering(b1, b2, selector, 0, 0);
    }

    private static float levenshteinDistanceWithNullFiltering(Birth b1, Birth b2, int selector, float distance_for_one_unknown, float distance_for_two_unknowns) {
