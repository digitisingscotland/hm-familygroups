 ...
 */
public class BirthToCannonicalBirthDeath {

    IBucket<Birth> source_bucket;
    IBucket destination_bucket;

    public BirthToCannonicalBirthDeath(String store_name, String repo_name, String source_bucket_name, String dest_bucket_name) throws RepositoryException {
    ...
    public int convertRecords() throws BucketException {
        ...
        IInputStream<Birth> source_stream = source_bucket.getInputStream();

        int count = 0;

        for (Birth record : source_stream) {
            ...
            bd.put( BirthDeath.GROUND_TRUTH, record.getString( Birth.DEATH ) );
    ...
    public static void main( String[] args ) throws IOException, RepositoryException, RecordFormatException, BucketException {
        if (args.length >= ARG_NAMES.length) {
            ...
            BirthToCannonicalBirthDeath mapper = new BirthToCannonicalBirthDeath(store_name, repo_name, source_bucket_name, dest_bucket_name);
